...
export const styles = StyleSheet.create({
  ...
  optInRow: { alignItems: 'center', backgroundColor: '#FFFFFF', borderColor: THEME.line, borderRadius: 18, borderWidth: 1, flexDirection: 'row', gap: 12, marginTop: 20, padding: 16 },
  optInCopy: { flex: 1 },
  optInTitle: { color: THEME.ink, fontSize: 15, fontWeight: '700' },
  optInHint: { color: THEME.muted, fontSize: 12, lineHeight: 17, marginTop: 4 },
